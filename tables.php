                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-primary">
                            ...
                            <button class="btn peach-gradient waves-effect waves-light btn-sm">
                        ...
                        <tr>
                          ...
                          <td class="text-primary">
                            <button type="button" rel="tooltip" title="Edit Task"
                              class="btn btn-white btn-link  waves-effect waves-light btn-sm">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-hover" id="dtBasicExample2">
                      ...
                      <tbody>
                        <?php foreach($data as $qrcode): ?>
                        <tr>
                          <td><?= $qrcode->qrcode ?></td>
                          <td>
                            <img src="http://noval7sihabibi.000webhostapp.com/qrcodes/<?= $qrcode->qrcode ?>.png" alt="" class="img-responsive" width="150px">
